...
export default function ProductCard({ name, img, description, price, hidden }) {
    return (
        <div className={`${hidden ? 'sm:hidden' : ''} sm:h-[368px] h:[260px] sam:w-[150px] iphone:w-[165px] sm:w-[278px]`}>
            <div className='rounded-2xl flex items-center justify-center bg-secondary sam:w-[150px] iphone:w-[165px] h-[200px] sm:w-[278px] sm:h-[216px]'>
                <img
                    className='w-[70%] hover:scale-110 transition-transform duration-300 ease-in-out'
                    src={img}
                    alt={name}
                />
            </div>
