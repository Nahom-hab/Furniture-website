...
export default function MostProductcCard({ name, img, price, discountedPrice, star }) {
    return (
        <div className='md:w-[227px] w-[190px] text-black h-[220px] md:h-[240px]'>
            <img src={img} className='md:w-[227px] md:h-[178px] object-cover rounded-2xl' alt="" />
            ...
            <div className='flex items-center'>
                <div className='flex w-[80%] items-end'>
                    <div className='md:text-[24px] text-[18px]  text-slate-800'>{discountedPrice}<span className='text-[16px] ml-[-4px]'>birr</span></div>
