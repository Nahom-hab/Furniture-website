                    ...
                    <div className='flex gap-3'>
                        <div>
                            <div className="mt-4 text-sm text-green-600 font-semibold">
                                <span className='font-bold'>{isEng ? 'In Stock:' : 'በእቃ ውስጥ:'}</span> {isEng ? 'Only 5 left!' : 'የቀረው 5 ብቻ ነው!'}
                            </div>
                    ...
                    <div className='flex items-start gap-20'>
                        <details className="mt-4 h-[160px] w-[160px] cursor-pointer">
                            ...
                            <div className="text-sm mt-2 text-gray-700">
                                <p><strong>{isEng ? 'Material:' : 'እቃ ዝርዝር:'}</strong> 100% Leather</p>
                                <p><strong>{isEng ? 'Dimensions:' : 'መጠን:'}</strong> 200cm x 90cm x 85cm</p>
                                <p><strong>{isEng ? 'Available Colors:' : 'የሚገኙ ቀለሞች:'}</strong> Gray, Black, White</p>
                            </div>
                        </details>
